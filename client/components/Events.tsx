  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        ></div>
        <div
          className="absolute top-1/3 left-12 w-4 h-4 bg-gdsc-blue rotate-45 opacity-25 animate-float"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute bottom-16 left-16 w-4 h-4 bg-gdsc-green rounded-full opacity-25 animate-float"
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="grid grid-cols-16 gap-6 h-full">
            {Array.from({ length: 32 }).map((_, i) => (
              <div
                key={i}
                className="border-r border-red-200 animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-block relative mb-6">
            <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-gdsc-red via-gdsc-yellow to-gdsc-green bg-clip-text text-transparent mb-4 animate-gradient-x">
              Upcoming Events
            </h2>
            {/* Decorative elements */}
            <div className="absolute -top-2 -left-2 w-4 h-4 bg-gdsc-red rounded-full animate-ping opacity-60"></div>
            <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-gdsc-green rotate-45 animate-pulse opacity-50"></div>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="relative text-center py-16 backdrop-blur-lg bg-gradient-to-br from-white/80 to-white/60 border border-white/30 shadow-2xl rounded-3xl overflow-hidden">
            {/* Animated background elements */}
            <div className="absolute inset-0 opacity-30">
              <div
                className="absolute top-8 left-8 w-3 h-3 bg-gdsc-red rounded-full animate-ping"
                style={{ animationDelay: "0s" }}
              ></div>
              <div
                className="absolute top-12 right-12 w-2 h-2 bg-gdsc-yellow rounded-full animate-ping"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute bottom-12 left-16 w-2 h-2 bg-gdsc-green rounded-full animate-ping"
                style={{ animationDelay: "2s" }}
              ></div>
              <div
                className="absolute bottom-8 right-8 w-3 h-3 bg-gdsc-blue rounded-full animate-ping"
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-gdsc-red to-gdsc-yellow bg-clip-text text-transparent mb-6">
