  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-20 left-10 w-12 h-12 bg-gradient-to-r from-gdsc-blue to-gdsc-red rounded-full opacity-20 animate-float"
          style={{ animationDelay: "0s" }}
        ></div>
        <div
          className="absolute top-40 right-20 w-8 h-8 bg-gradient-to-r from-gdsc-yellow to-gdsc-green rotate-45 opacity-25 animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-40 left-20 w-6 h-6 bg-gdsc-red rounded-full opacity-30 animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-20 right-10 w-10 h-10 bg-gradient-to-r from-gdsc-green to-gdsc-blue rounded-full opacity-20 animate-float"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/4 w-4 h-4 bg-gdsc-yellow rotate-45 opacity-25 animate-float"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/3 w-14 h-14 bg-gradient-to-r from-gdsc-red to-gdsc-yellow rounded-full opacity-15 animate-float"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-block relative mb-6">
            ...
            <div
              className="absolute -bottom-1 -left-1 w-4 h-4 bg-gdsc-red rotate-45 animate-pulse opacity-50"
              style={{ animationDelay: "0.5s" }}
            ></div>
          </div>
        ...
        <div className="relative group p-8 md:p-12 rounded-3xl backdrop-blur-lg bg-gradient-to-br from-white/70 to-white/50 border border-white/30 shadow-2xl text-center mb-16 overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-30">
            <div
              className="absolute top-6 left-6 w-3 h-3 bg-gdsc-blue rounded-full animate-ping"
              style={{ animationDelay: "0s" }}
            ></div>
            <div
              className="absolute top-12 right-8 w-2 h-2 bg-gdsc-red rounded-full animate-ping"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute bottom-8 left-12 w-2 h-2 bg-gdsc-yellow rounded-full animate-ping"
              style={{ animationDelay: "2s" }}
            ></div>
            <div
              className="absolute bottom-6 right-6 w-3 h-3 bg-gdsc-green rounded-full animate-ping"
              style={{ animationDelay: "0.5s" }}
            ></div>
          </div>
        ...
        <div className="relative group p-8 md:p-12 rounded-3xl backdrop-blur-lg bg-gradient-to-br from-white/70 to-white/50 border border-white/30 shadow-2xl text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed mb-10 font-medium">
              ...
              to everyone through workshops, events, and more. Dreamers, problem
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {[
                ...
                {
                  value: "Collaboration",
                  color: "from-gdsc-green to-green-600",
                },
                { value: "Learning", color: "from-gdsc-red to-red-600" },
                {
                  value: "Inclusivity",
                  color: "from-gdsc-yellow to-yellow-600",
                },
