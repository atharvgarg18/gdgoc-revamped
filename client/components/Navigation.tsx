...
export default function Navigation() {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 safe-area-inset ${
        isScrolled 
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-2 md:space-x-3 group">
              <div className="flex space-x-1">
                ...
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-gdsc-red group-hover:animate-pulse" style={{ animationDelay: "0.1s" }}></div>
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-gdsc-yellow group-hover:animate-pulse" style={{ animationDelay: "0.2s" }}></div>
                <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-gdsc-green group-hover:animate-pulse" style={{ animationDelay: "0.3s" }}></div>
              </div>
            ...
            <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              ...
              >
                Home
                <span className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-gdsc-blue transition-all duration-300 group-hover:w-full ${
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          {/* Mobile Menu Panel */}
          <div className={`fixed top-16 left-0 right-0 bg-white border-b border-gray-200 shadow-xl transform transition-all duration-300 ${
