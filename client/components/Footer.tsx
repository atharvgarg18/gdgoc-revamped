  ...
  return (
    <footer ref={footerRef} className="relative bg-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 right-20 w-16 md:w-24 h-16 md:h-24 bg-gdsc-red/10 rounded-full animate-float" style={{ animationDelay: "1s" }}></div>
        <div className="absolute bottom-20 left-1/4 w-12 md:w-16 h-12 md:h-16 bg-gdsc-yellow/10 rounded-full animate-float" style={{ animationDelay: "2s" }}></div>
        <div className="absolute bottom-10 right-1/3 w-24 md:w-40 h-24 md:h-40 bg-gdsc-green/10 rounded-full animate-float" style={{ animationDelay: "0.5s" }}></div>
      ...
      <div className="relative z-10 container-responsive py-12 md:py-16">
        <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 md:gap-12 mb-8 md:mb-12">
            ...
            <div className="lg:col-span-2">
              <Link to="/" className="flex items-center space-x-3 mb-6 group">
                <div className="flex space-x-1">
                  ...
                  <div className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-gdsc-red group-hover:animate-pulse" style={{ animationDelay: "0.1s" }}></div>
                  <div className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-gdsc-yellow group-hover:animate-pulse" style={{ animationDelay: "0.2s" }}></div>
                  <div className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-gdsc-green group-hover:animate-pulse" style={{ animationDelay: "0.3s" }}></div>
                </div>
              ...
              <p className="text-gray-300 leading-relaxed max-w-md mb-6 text-sm md:text-base">
                ...
                students learning and growing together through technology and innovation.
              </p>
              ...
              <div className="mb-6">
                ...
                <SocialIcons
                  links={{
                    ...
                    whatsapp: "https://chat.whatsapp.com/CcTjDYXNfQMEoLUHzB3hwa"
                  }}
                  size="md"
                  variant="footer"
                />
            ...
            {/* Resources & Join */}
            <div>
              <h3 className="font-bold text-lg mb-6 text-gdsc-green">Get Involved</h3>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
                <p className="text-gray-400 text-sm text-center md:text-left">
                  © {currentYear} Google Developer Groups on Campus IET DAVV. All rights reserved.
                </p>
