  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-32 md:top-40 right-8 md:right-20 w-4 h-4 md:w-6 md:h-6 bg-gdsc-red rotate-45 animate-float opacity-50" style={{ animationDelay: "1s" }}></div>
        <div className="absolute bottom-32 md:bottom-40 left-8 md:left-20 w-3 h-3 md:w-5 md:h-5 bg-gdsc-yellow rounded-full animate-float opacity-70" style={{ animationDelay: "2s" }}></div>
        <div className="absolute bottom-16 md:bottom-20 right-4 md:right-10 w-5 h-5 md:w-8 md:h-8 bg-gdsc-green rounded-full animate-float opacity-40" style={{ animationDelay: "0.5s" }}></div>
      ...
      <div className="relative z-10 text-center container-responsive">
        <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="flex justify-center mb-6 md:mb-8">
            <div className="flex items-center space-x-3">
              <div className="flex space-x-1">
                ...
                <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-gdsc-red animate-pulse" style={{ animationDelay: "0.2s" }}></div>
                <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-gdsc-yellow animate-pulse" style={{ animationDelay: "0.4s" }}></div>
                <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-gdsc-green animate-pulse" style={{ animationDelay: "0.6s" }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
            <div className="group">
              <div className="text-2xl md:text-3xl font-bold text-gdsc-blue group-hover:scale-110 transition-transform duration-300">500+</div>
            ...
            <div className="group">
              <div className="text-2xl md:text-3xl font-bold text-gdsc-yellow group-hover:scale-110 transition-transform duration-300">20+</div>
              <div className="text-gray-600 text-sm md:text-base">Projects</div>
            </div>
            <div className="group">
              <div className="text-2xl md:text-3xl font-bold text-gdsc-green group-hover:scale-110 transition-transform duration-300">100+</div>
      ...
      <div className="absolute bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className="w-5 h-8 md:w-6 md:h-10 border-2 border-gray-400 rounded-full flex justify-center hover:border-gdsc-blue transition-colors cursor-pointer" onClick={() => window.scrollTo({ top: window.innerHeight, behavior: 'smooth' })}>
