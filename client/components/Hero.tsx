          ...
          <div className="flex justify-center mb-8">
            <div className="flex items-center space-x-3">
              <div className="flex space-x-1">
                ...
                <div
                  className="w-8 h-8 rounded-full bg-gdsc-red animate-pulse"
                  style={{ animationDelay: "0.2s" }}
                ></div>
                <div
                  className="w-8 h-8 rounded-full bg-gdsc-yellow animate-pulse"
                  style={{ animationDelay: "0.4s" }}
                ></div>
                <div
                  className="w-8 h-8 rounded-full bg-gdsc-green animate-pulse"
