...
export default function AdminLayout({ children, onLogout }: AdminLayoutProps) {
  ...
  const navigation = [
    { name: 'Events', href: '/admin/events', current: location.pathname === '/admin/events' },
    { name: 'Team', href: '/admin/team', current: location.pathname === '/admin/team' },
    { name: 'Gallery', href: '/admin/gallery', current: location.pathname === '/admin/gallery' },
  ];
