...
export default function GalleryPage() {
  ...
  const categories = [
    ...
    { value: 'workshop', label: 'Workshops', count: galleryItems.filter(i => i.category === 'workshop').length },
    { value: 'event', label: 'Events', count: galleryItems.filter(i => i.category === 'event').length },
    { value: 'competition', label: 'Competitions', count: galleryItems.filter(i => i.category === 'competition').length },
    { value: 'community', label: 'Community', count: galleryItems.filter(i => i.category === 'community').length },
  ];

  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'workshop': return { bg: 'bg-gdsc-blue', text: 'text-white', border: 'border-gdsc-blue' };
      case 'event': return { bg: 'bg-gdsc-red', text: 'text-white', border: 'border-gdsc-red' };
      case 'competition': return { bg: 'bg-gdsc-yellow', text: 'text-white', border: 'border-gdsc-yellow' };
      case 'community': return { bg: 'bg-gdsc-green', text: 'text-white', border: 'border-gdsc-green' };
      ...
      <main className="pt-16">
        ...
        <section className="relative py-16 md:py-24 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-20 right-8 md:right-20 w-12 md:w-24 h-12 md:h-24 bg-gdsc-red/5 rounded-full animate-float" style={{ animationDelay: "2s" }}></div>
            <div className="absolute bottom-20 left-8 md:left-1/4 w-20 md:w-40 h-20 md:h-40 bg-gdsc-yellow/5 rounded-full animate-float" style={{ animationDelay: "4s" }}></div>
            <div className="absolute bottom-10 right-4 md:right-1/3 w-14 md:w-28 h-14 md:h-28 bg-gdsc-green/5 rounded-full animate-float" style={{ animationDelay: "1s" }}></div>
          ...
          <div className="relative z-10 container-responsive text-center">
            ...
            <div className="flex justify-center mb-6 md:mb-8">
              <div className="flex space-x-1">
                ...
                <div className="w-6 md:w-8 h-6 md:h-8 rounded-full bg-gdsc-red animate-pulse" style={{ animationDelay: "0.2s" }}></div>
                <div className="w-6 md:w-8 h-6 md:h-8 rounded-full bg-gdsc-yellow animate-pulse" style={{ animationDelay: "0.4s" }}></div>
                <div className="w-6 md:w-8 h-6 md:h-8 rounded-full bg-gdsc-green animate-pulse" style={{ animationDelay: "0.6s" }}></div>
              </div>
            </div>
            ...
            {isLoading ? (
              <div className="flex justify-center items-center h-64">
                <div className="flex space-x-2">
                  ...
                  <div className="w-3 h-3 md:w-4 md:h-4 bg-gdsc-red rounded-full animate-pulse" style={{ animationDelay: "0.2s" }}></div>
                  <div className="w-3 h-3 md:w-4 md:h-4 bg-gdsc-yellow rounded-full animate-pulse" style={{ animationDelay: "0.4s" }}></div>
                  <div className="w-3 h-3 md:w-4 md:h-4 bg-gdsc-green rounded-full animate-pulse" style={{ animationDelay: "0.6s" }}></div>
                </div>
              </div>
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">No Gallery Items Found</h3>
              ...
              <>
                ...
                <div className="text-center mb-8 md:mb-12">
                  <p className="text-gray-600">
                    Showing <span className="font-semibold text-gdsc-blue">{filteredItems.length}</span> 
                    {selectedCategory === 'all' ? ' items' : ` ${selectedCategory} items`}
                  </p>
                </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative aspect-video overflow-hidden rounded-t-2xl">
                          ...
                          {/* Category badge */}
                          <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-semibold ${categoryStyle.bg} ${categoryStyle.text} shadow-lg`}>
                            {item.category}
                          </div>
                        </div>
                        ...
                        <div className="p-6 relative">
                          ...
                          <div className="relative z-10">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              {/* View button */}
                              <button className={`px-3 py-1 rounded-full text-xs font-medium border-2 transition-all duration-300 ${categoryStyle.border} ${categoryStyle.text} hover:${categoryStyle.bg} hover:text-white`}>
                                View
                              </button>
                            </div>
                          </div>
                          ...
                          {/* Floating element */}
                          <div className="absolute -bottom-2 -right-2 w-6 h-6 bg-gdsc-yellow rounded-full animate-float opacity-60" style={{ animationDelay: `${index * 0.5}s` }}></div>
                        </div>
                      </div>
                    );
                  })}
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-10 right-10 w-20 md:w-32 h-20 md:h-32 bg-gdsc-green/5 rounded-full animate-float" style={{ animationDelay: "2s" }}></div>
            <div className="absolute top-1/2 left-1/4 w-12 h-12 bg-gdsc-red/5 rounded-full animate-float" style={{ animationDelay: "1s" }}></div>
          </div>
          ...
          <div className="relative z-10 container-responsive text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
                Join our community and create memories that will be featured in our gallery. 
                Every workshop, event, and project is a step towards building the future.
              </p>
              ...
              <div className="mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                ...
                <div className="group">
                  <div className="text-2xl md:text-3xl font-bold text-gdsc-green group-hover:scale-110 transition-transform duration-300">
                    {galleryItems.filter(i => i.category === 'community').length}+
                  </div>
                  <div className="text-gray-600 text-sm md:text-base">Community</div>
                </div>
              </div>
            </div>
          </div>
