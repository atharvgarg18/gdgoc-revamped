        ...
        <div className="text-center px-4">
          <div className="flex justify-center mb-8">
            <div className="flex space-x-2">
              ...
              <div
                className="w-12 h-12 rounded-full bg-gdsc-red animate-pulse"
                style={{ animationDelay: "0.2s" }}
              ></div>
              <div
                className="w-12 h-12 rounded-full bg-gdsc-yellow animate-pulse"
                style={{ animationDelay: "0.4s" }}
              ></div>
              <div
                className="w-12 h-12 rounded-full bg-gdsc-green animate-pulse"
